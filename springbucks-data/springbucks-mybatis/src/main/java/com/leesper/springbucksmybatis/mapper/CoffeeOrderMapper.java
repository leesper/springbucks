...
public interface CoffeeOrderMapper {
    public CoffeeOrder createOrder(@Param("customer") String customer, @Param("coffee") Coffee... coffee);
    public boolean updateState(@Param("order") CoffeeOrder order, @Param("state") OrderState state);
}
